...
namespace MusicAppApi.Helpers.Extensions.ExpressionExtension
{
    public static class TreeExpression
    {
        public class ExpressionTreeHelper<T> where T : PlaceDescription
        {
            ...
            {
                Type baseType = typeof(T);
                expressionMethodPairs.Add(baseType.GetProperty("KeyWords"), MatchKeyWords);
                ...
                expressionMethodPairs.Add(baseType.GetProperty("Name"), NameIsCloseToFilter);
            ...
            public Expression<Func<T, bool>> GetFilterExpression()
            {
                ...
                {
                    if (property.Name == "PageSize" || property.Name == "PageNumber")
                        continue;
                        
                    if (CheckEmptyness(property))
                    {
