...
namespace MusicAppApi.Migrations
{
    ...
    [Migration("20211217110134_User history added")]
    partial class Userhistoryadded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicAppApi.Models.AudioFile", b =>
                {
                    ...
                    b.Property<DateTime>("UploadTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 12, 17, 13, 1, 31, 746, DateTimeKind.Local).AddTicks(5817));
            ...
            modelBuilder.Entity("MusicAppApi.Models.PhotoFile", b =>
                {
                    ...
                    b.Property<DateTime>("UploadTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 17, 13, 1, 31, 755, DateTimeKind.Local).AddTicks(8384));
            ...
            modelBuilder.Entity("MusicAppApi.Models.UserVisitHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("VisitTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 17, 13, 1, 31, 776, DateTimeKind.Local).AddTicks(5649));
            ...
            modelBuilder.Entity("MusicAppApi.Models.VideoFile", b =>
                {
                    ...
                    b.Property<DateTime>("UploadTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 17, 13, 1, 31, 755, DateTimeKind.Local).AddTicks(7161));
            ...
            modelBuilder.Entity("MusicAppApi.Models.UserVisitHistory", b =>
                {
                    ...
                    b.HasOne("MusicAppApi.Models.PlaceDescription", "VisitedPlace")
                        .WithMany("UserVisits")
